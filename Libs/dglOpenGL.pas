...
{==============================================================================}
{ Header based on glext.h  rev 56 (2009-09-24)                                 }
{ Header based on wglext.h rev 17 (2009/09/16)                                 }
{ Header based on glxext.h rev 25 (2009/10/08)  (only Core/ARB/EXT)            }
{                                                                              }
...
//  TglVideoParameterivNV = procedure(video_slot: GLuint; pname: GLenum; const params: PGLint); {$IFDEF DGL_WIN}stdcall; {$ELSE}cdecl; {$ENDIF}
  ...
  TglNamedMakeBufferResidentNV = procedure(buffer: GLuint; access: GLenum); {$IFDEF DGL_WIN}stdcall; {$ELSE}cdecl; {$ENDIF}
  TglNamedMakeBufferNonResidentNV = procedure(buffer: GLuint); {$IFDEF DGL_WIN}stdcall; {$ELSE}cdecl; {$ENDIF}
...
//  glVideoParameterivNV: TglVideoParameterivNV;
  ...
  glNamedMakeBufferResidentNV: TglNamedMakeBufferResidentNV;
  glNamedMakeBufferNonResidentNV: TglNamedMakeBufferNonResidentNV;
...
begin
  ...
  glNamedMakeBufferResidentNV := dglGetProcAddress('glNamedMakeBufferResidentNV');
  glNamedMakeBufferNonResidentNV := dglGetProcAddress('glNamedMakeBufferNonResidentNV');
